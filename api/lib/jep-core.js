...
- Breckenridge Pharmaceutical (generic pharmaceutical manufacturer, Provo UT): Portfolio Strategy Intern, Aug 2026 - present. Building a valuation model scoring product opportunities on risk-adjusted NPV, payback, and required investment; developing a five-year growth plan with revenue and margin projections guiding licensing and acquisition decisions; stress-testing investment thresholds through sensitivity analysis, presenting recommendations to the C-suite.
...
- BYU AI Foundry (student-run AI product studio): Founding Member and Director of Product, May 2026 - present. Product lead on a generic-pharma client engagement (~80% management consulting, 20% AI building): audit of present-state operations, scoping the hypothesis of what inputs predict whether a project is worth pursuing in a razor-thin-margin generics market; holding the build until an audit confirms the client's evaluation process is sound.
...
- President, BYU chapter of the Adam Smith Society (he writes it "A.S.S." and enjoys the acronym). MBANBA intramural basketball team captain.
