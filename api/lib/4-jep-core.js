...
- Fiddle (pre-PMF operations software startup, Provo): founding sales role, Jan 2022 - Oct 2022. Ran 150+ customer discovery calls (live selling motions, not interviews), built the tracker synthesizing which value props earned traction, reported customer signal directly to the founder-CTO in the same room as the two engineers, rewrote GTM scripts off each product change.
